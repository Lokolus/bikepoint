...
<main>
    ...
    <!-- Großes Bild Sektion -->
    <section style="position: relative; min-height: 70vh; display: flex; align-items: center; justify-content: center; background-image: url('assets/images/auf.jpg'); background-size: cover; background-position: center 70%; filter: grayscale(100%);">
    ...
    <section style="padding: 4rem 0; text-align: center; background-color: #0A0A0A; position: relative; overflow: hidden;">
        <!-- Background Image -->
        <div style="position: absolute; inset: 0; background-image: url('assets/images/19.08.25-330.jpg'); background-size: cover; background-position: center; filter: grayscale(100%); opacity: 0.45;"></div>
