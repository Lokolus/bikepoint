...
<main>
    ...
    <!-- Großes Bild Sektion -->
    <section style="position: relative; min-height: 70vh; display: flex; align-items: center; justify-content: center; background-image: url('assets/images/auf.jpg'); background-size: cover; background-position: center; filter: grayscale(100%);">
