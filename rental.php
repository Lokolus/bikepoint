...
<main>
    ...
    <section style="padding: 4rem 0; text-align: center; background-color: #0A0A0A; position: relative; overflow: hidden;">
        <!-- Background Image -->
        <div style="position: absolute; inset: 0; background-image: url('assets/images/chill.jpg'); background-size: cover; background-position: center; filter: grayscale(100%); opacity: 0.45;"></div>
